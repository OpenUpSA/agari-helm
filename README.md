...
Complete authentication, file management, project management, and data indexing.
...
- **Realm**: `agari`
  ...
  - **Client**:
    - `dms` - Data Management System. Policy enforcement: `permissive` and Decision strategy: `affirmative`
      - **Scopes**:
        - `READ`
        - `WRITE`
        - `ADMIN`
